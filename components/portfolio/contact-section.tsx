          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            >
              ...
              >
                ...
                >
                  <a href="https://drive.google.com/file/d/1W-51kTQey7DlQMO88nXkDhYcMacOhqr7/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                    Souvagya's Resume
                  </a>
                </Button>
              </motion.div>
